...
with torch.no_grad():
    ...
    #         input_full = np.expand_dims(input_img, axis=0) * ratio
            
    #         # scale_full = np.expand_dims(input_img, axis=0)
    ...
    #         # gray_img = (1.0 - (0.299*r + 0.587*g + 0.114*b)/2.0)
    #         # gray_img = np.expand_dims(gray_img, axis=2)
    #         # gray_full = np.expand_dims(gray_img, axis=0) * ratio
    ...
    #         in_gray_img = in_gray_img.to(device)
