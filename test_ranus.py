...
input_dir = './dataset/RANUS/test/low/'
gt_dir = './dataset/RANUS/test/high/'
edge_dir = './dataset/RANUS/test/edge/'
list_file= './dataset/RANUS/test_list.txt'
checkpoint_dir = './IC15_004_results/result_IC15_gray_map_enhanced_edge_map/'
result_dir = './result_RANUS/'
...
with torch.no_grad():
    ...
    for test_id in test_ids:
        in_file = input_dir + '%d.png' % test_id
        print(in_file)
        in_path = in_file
        gt_file = gt_dir + '%d.png' % test_id
        gt_path = gt_file
        ratio = 25
        ...
        r,g,b = gt_img[0,0,:,:]+1, gt_img[0,1,:,:]+1, gt_img[0,2,:,:]+1
